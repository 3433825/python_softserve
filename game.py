...
def game_numbers():
    keep_going = "y"
    while keep_going == "y":
        alex_turn = input('Alex, are you in game? Type "y" or "n", please, and then type Enter:')
        ...
        keep_going = input('We are still going on? Type "y" or "n", please, and then type Enter:')
